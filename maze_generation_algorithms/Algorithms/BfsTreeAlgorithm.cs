...
{
    /// <summary>
    /// Uses breadth-first search to build a spanning tree over non-frozen cells.
    /// Structure tends to have shorter average path length and more "bushy" feel
    /// than DFS, which is useful for micromouse-style turning behavior tests.
    /// </summary>
    public class BfsTreeAlgorithm : IMazeAlgorithm
    {
